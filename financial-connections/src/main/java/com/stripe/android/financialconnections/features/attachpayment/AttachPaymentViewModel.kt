    ...
    init {
        ...
        suspend {
            ...
            val (result, millis) = measureTimeMillis {
                ...
                ).also { goNext(it.nextPane ?: ClientPane.SUCCESS) }
            }
    ...
    private fun logErrors() {
        onAsync(
            ...
            onFail = {
                ...
                eventTracker.track(Error(ClientPane.ATTACH_LINKED_PAYMENT_ACCOUNT, it))
            },
            onSuccess = {
                eventTracker.track(PaneLoaded(ClientPane.ATTACH_LINKED_PAYMENT_ACCOUNT))
            }
        )
        onAsync(
