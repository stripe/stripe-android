...
private const val InitializationDelayMillis = 200L

internal abstract class SharedPartnerAuthViewModel(
    private val completeAuthorizationSession: CompleteAuthorizationSession,
    protected val createAuthorizationSession: PostAuthorizationSession,
    ...
    private val initialState: SharedPartnerAuthState,
    ...
    abstract suspend fun fetchPayload(sync: SynchronizeSessionResponse): Payload
    ...
    private fun initializeState() {
        suspend {
            // This is a bad workaround to prevent the subclass' fetchPayload from being called
