...
private class FinancialConnectionsManifestRepositoryImpl(
    ...
    override suspend fun getOrSynchronizeFinancialConnectionsSession(
        clientSecret: String,
        applicationId: String,
        tokenGenerationAvailable: Boolean?,
        reFetchCondition: (SynchronizeSessionResponse) -> Boolean
        ...
        apiRequestFactory.createPost(
            ...
            params = mapOf(
                ...
                "mobile" to mapOf(
                    ...
                    PARAMS_SUPPORT_APP_VERIFICATION to tokenGenerationAvailable,
                    PARAMS_VERIFY_APP_ID to applicationId.takeIf { tokenGenerationAvailable == true },
