...
* [ADDED][7282](https://github.com/stripe/stripe-android/pull/7282) PaymentSheet now supports Boleto PaymentIntents, SetupIntents, and PaymentIntents with setup for future usage.
