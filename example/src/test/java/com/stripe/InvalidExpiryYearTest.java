...
public class InvalidExpiryYearTest extends StripeFunctionalTest {

    @Test
    public void invalid_expiry_year() throws Exception {
        ...
        assertEquals(StripeError.CardErrorCode.InvalidExpYear, errorResponse[0].cardErrorCode);
        assertEquals("expYear", errorResponse[0].parameter);
    }
