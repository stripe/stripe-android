...
class GooglePayPaymentMethodLauncherComposeWithFilterActivity : AppCompatActivity() {
    ...
    private val googlePayConfig = GooglePayPaymentMethodLauncher.Config(
        ...
        cardBrandFilter = AcceptableBrandsFilter(CardBrand.Visa)
    )
