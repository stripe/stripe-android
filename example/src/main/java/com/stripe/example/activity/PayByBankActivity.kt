...
class PayByBankActivity : StripeIntentActivity() {
                    ...
                    onClick = {
                        createAndConfirmPaymentIntent(
                            ...
                            paymentMethodCreateParams = PaymentMethodCreateParams.create(
                                payByBank = PaymentMethodCreateParams.PayByBank(selectedBank),
