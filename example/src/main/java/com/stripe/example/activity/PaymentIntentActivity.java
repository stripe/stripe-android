...
public class PaymentIntentActivity extends AppCompatActivity {
    ...
    Button mConfirmPaymentIntent;
    Button mRetrievePaymentIntent;
    CardInputWidget mCardInputWidget;
    TextView mPaymentIntentValue;
    ...
    void createPaymentIntent() {
        Observable observable = mStripeService.createPaymentIntent(createPaymentIntentParams());
