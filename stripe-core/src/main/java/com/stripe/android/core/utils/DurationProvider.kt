...
interface DurationProvider {
    ...
    enum class Key {
        ...
        PaymentSheetLoadCreateLinkStateGetLinkDisabledReasons,
        PaymentSheetLoadCreateLinkStateCreateLinkConfiguration,
        PaymentSheetLoadCreateLinkStateGetLinkAccountStatus,
        PaymentSheetLoadCreateLinkStateRetrieveCustomerEmail,
