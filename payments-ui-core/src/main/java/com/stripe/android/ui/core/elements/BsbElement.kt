...
class BsbElement(
    ...
    override val controller: TextFieldController = SimpleTextFieldController(
        textFieldConfig = BsbConfig(auBecsDebitBanks),
...
private val auBecsDebitBanks: List<BecsDebitBanks.Bank> = listOf(
    ...
    BecsDebitBanks.Bank("369", "BNK Banking Corporation Ltd"),
    BecsDebitBanks.Bank("370", "Flash Partners Pty Ltd"),
    BecsDebitBanks.Bank("392", "Fat Zebra Pty Ltd"),
    ...
    BecsDebitBanks.Bank("560", "Ebury Partners Australia Pty Ltd"),
    BecsDebitBanks.Bank("585", "Bano"),
    BecsDebitBanks.Bank("599", "Corporate Alliance"),
    ...
    BecsDebitBanks.Bank("671", "Cuscal Limited"),
    BecsDebitBanks.Bank("676", "Gateway Credit Union"),
    BecsDebitBanks.Bank("680", "Greater Bank Limited"),
    BecsDebitBanks.Bank("681", "CHINA EVERBRIGHT BANK CO., LTD."),
    BecsDebitBanks.Bank("688", "International Bank of Australia"),
    BecsDebitBanks.Bank("690", "Islamic Bank Australia"),
    ...
    BecsDebitBanks.Bank("771", "AFT AU PTY LTD"),
    BecsDebitBanks.Bank("772", "Revolut Payments Australia Pty Ltd"),
    BecsDebitBanks.Bank("774", "Wise Australia Pty Ltd"),
    ...
    BecsDebitBanks.Bank("828", "China Merchants Bank, Sydney"),
    BecsDebitBanks.Bank("833", "Defence Bank Limited"),
    BecsDebitBanks.Bank("834", "Great Southern Business Bank"),
    BecsDebitBanks.Bank("840", "Split Payments Pty Ltd"),
    BecsDebitBanks.Bank("850", "PAYNOW TECHNOLOGY PTY LTD"),
    BecsDebitBanks.Bank("855", "Strong Customer Authentication"),
    ...
    BecsDebitBanks.Bank("890", "Avenue Bank Ltd"),
    BecsDebitBanks.Bank("898", "Agricultural Bank of China Limited"),
    BecsDebitBanks.Bank("911", "Sumitomo Mitsui Banking Corporation"),
    BecsDebitBanks.Bank("913", "State Street Bank & Trust Company"),
    BecsDebitBanks.Bank("914", "Barclays Bank PLC"),
    ...
    BecsDebitBanks.Bank("949", "State Bank of India"),
    ...
    BecsDebitBanks.Bank("013943", "Australia and New Zealand Banking Group"),
    ...
    BecsDebitBanks.Bank("020", "The Northern Trust Company Australia")
