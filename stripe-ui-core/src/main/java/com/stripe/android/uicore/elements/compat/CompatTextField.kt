...
/**
 * Custom filled [TextField] composable for Stripe purposes.
 *
 * @param value the input [String] to be shown in the text field
 * @param onValueChange the callback that is triggered when the input service updates values in
 * [String]. An updated [String] comes as a parameter of the callback
...
internal fun Decoration(
    ...
    val colorAndEmphasis: @Composable () -> Unit = @Composable {
        CompositionLocalProvider(LocalContentColor provides contentColor.copy(alpha = contentAlpha ?: contentColor.alpha)) {
            content()
        }
    }
...
private val AutofillTransparentColor = Color(0x00000000)
