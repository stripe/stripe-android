...
fun StripeTypography.toComposeTypography(): Typography {
    ...
    // headlineLarge (formerly h4) is our largest headline. It is used for the most important labels in our UI
    ...
    // headlineMedium (formerly h5) is our medium headline label.
    ...
    // headlineSmall (formerly h6) is our smallest headline label.
    ...
    return materialTypography.copy(
        ...
        titleLarge = materialTypography.titleLarge.toCompat(),
