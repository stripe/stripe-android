...
internal interface CryptoRepository {
     ...
     */
    suspend fun submitKycInfo(kycInfo: OnRampCoordinator.KycInfo): kotlin.Result<Unit>
}
...
internal class CryptoApiRepository @Inject constructor(
    ...
    override suspend fun submitKycInfo(kycInfo: OnRampCoordinator.KycInfo): kotlin.Result<Unit> =
