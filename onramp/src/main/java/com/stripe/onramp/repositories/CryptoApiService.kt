...
internal interface CryptoApiService {
    ...
    suspend fun submitKycInfo(
        kycInfo: OnRampCoordinator.KycInfo,
...
internal class CryptoApiServiceImpl(
    ...
    private fun OnRampCoordinator.KycInfo.toParamMap(): Map<String, Any?> {
        return mapOf(
    ...
    private fun OnRampCoordinator.Address.toParamMap(): Map<String, Any?> {
        return mapOf(
            "line1" to line1,
            "line2" to line2,
            "city" to city,
    ...
    private fun OnRampCoordinator.GovernmentId.toParamMap(): Map<String, Any?> {
        return mapOf(
