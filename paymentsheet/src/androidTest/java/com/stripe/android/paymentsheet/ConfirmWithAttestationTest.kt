...
internal class ConfirmWithAttestationTest {
    ...
    private fun setupNewPaymentMethodTest(testContext: ProductIntegrationTestRunnerContext) {
        ...
        // Mock attestation activity to return success before launching
        mockAttestationActivity(AttestationActivityResult.Success(ATTESTATION_TOKEN))
    ...
    private fun mockAttestationActivity(result: AttestationActivityResult) {
