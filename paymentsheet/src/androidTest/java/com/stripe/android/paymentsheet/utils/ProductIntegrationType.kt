...
import com.stripe.android.elements.payment.PaymentSheet.ResultCallback

internal sealed class ProductIntegrationType(
    val expectedDeferredSSCResultCallback: ResultCallback,
) {
    ...
    data object FlowController : ProductIntegrationType(
        expectedDeferredSSCResultCallback = { result ->
            val failureResult = result as? Result.Failed
