...
internal object PromptPayDefinition : PaymentMethodDefinition {
    ...
    override fun uiDefinitionFactory(): UiDefinitionFactory = PromptPayPayUiDefinitionFactory
}

private object PromptPayPayUiDefinitionFactory : UiDefinitionFactory.RequiresSharedDataSpec {
    override fun createSupportedPaymentMethod(sharedDataSpec: SharedDataSpec) = SupportedPaymentMethod(
        ...
        iconResource = R.drawable.stripe_ic_paymentsheet_pm_promptpay,
    )
}
