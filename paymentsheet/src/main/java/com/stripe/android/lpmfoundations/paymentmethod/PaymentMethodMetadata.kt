    ...
    internal companion object {
        internal fun create(
            ...
            return PaymentMethodMetadata(
                ...
                displayableCustomPaymentMethods = createDisplayableCustomPaymentMethods(
                    elementsSession = elementsSession,
        ...
        private fun createDisplayableCustomPaymentMethods(
            elementsSession: ElementsSession,
            configuration: CommonConfiguration,
        ): List<DisplayableCustomPaymentMethod> {
            return elementsSession.customPaymentMethods.map { customPaymentMethod ->
                DisplayableCustomPaymentMethod.create(
