...
internal object BillingAddressSourceResolver {
    ...
    /**
     * Selects one billing-country input before the direct form builder creates form elements.
     *
     ...
     * Country-only sources keep their allowlist when they are promoted. Missing sources remain
     * missing unless Full or tax-minimum collection requires one.
     */
    fun resolve(
        source: Source,
