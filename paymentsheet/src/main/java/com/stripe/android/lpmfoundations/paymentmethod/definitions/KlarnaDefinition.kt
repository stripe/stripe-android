...
private object KlarnaUiDefinitionFactory : UiDefinitionFactory.Simple() {
    ...
    override fun buildFormElements(
        ...
        builder
            .header(formElement = getKlarnaHeader(metadata))
    ...
    private fun getKlarnaHeader(metadata: PaymentMethodMetadata): FormElement {
        val message = metadata.getPromotionForCode(PaymentMethod.Type.Klarna.code)
