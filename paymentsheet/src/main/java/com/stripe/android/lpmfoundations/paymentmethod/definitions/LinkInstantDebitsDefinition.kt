...
internal object LinkInstantDebitsDefinition : PaymentMethodDefinition {
    ...
    override fun uiDefinitionFactory(): UiDefinitionFactory = LinkUiDefinitionFactory
}

private object LinkUiDefinitionFactory : UiDefinitionFactory.Simple {
    override fun createSupportedPaymentMethod(): SupportedPaymentMethod = SupportedPaymentMethod(
        code = LinkInstantDebitsDefinition.type.code,
