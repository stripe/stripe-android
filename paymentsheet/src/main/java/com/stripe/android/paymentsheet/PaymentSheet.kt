...
class PaymentSheet internal constructor(
    ...
    class Builder(internal val resultCallback: PaymentSheetResultCallback) {
         ...
         * the payment or setup. Use this for server-side payment confirmation workflows
         ...
         * CreateIntentResult with the client secret. The SDK will then automatically call
         * confirmationHandler.start() to handle 3DS and other authentication flows.
         * 
         * This callback is mutually exclusive with createIntentCallback - only one should be set.
         */
        fun confirmationTokenCallback(callback: ConfirmationTokenCallback) = apply {
            callbacksBuilder.confirmationTokenCallback(callback)
        }
    ...
    interface FlowController {
        ...
        class Builder(
             ...
             * @param callback Called with the ConfirmationToken result when the customer confirms
             * the payment or setup. Use this for server-side payment confirmation workflows
             * where the SDK generates ConfirmationTokens instead of completing payments directly.
             * 
             * This callback is mutually exclusive with createIntentCallback - only one should be set.
             */
            fun confirmationTokenCallback(callback: ConfirmationTokenCallback) = apply {
