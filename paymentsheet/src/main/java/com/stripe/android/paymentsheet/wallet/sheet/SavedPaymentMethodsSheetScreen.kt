...
import com.stripe.android.paymentsheet.databinding.StripeFragmentSavedPaymentMethodsSheetPrimaryButtonBinding
...
@Composable
internal fun SavedPaymentMethodsSheetScreen(
    viewModel: SavedPaymentMethodsSheetViewModel,
    modifier: Modifier = Modifier,
) {
    PaymentSheetScaffold(
        topBar = { PaymentSheetTopBar(viewModel) },
        content = { scrollModifier ->
            SavedPaymentMethodsSheetContent(viewModel, scrollModifier)
        },
        modifier = modifier,
    )
}
...
@Composable
internal fun SavedPaymentMethodsSheetContent(
    viewModel: SavedPaymentMethodsSheetViewModel,
    modifier: Modifier = Modifier,
) {
    ...
    Column(
        ...
        AndroidViewBinding(
            factory = StripeFragmentSavedPaymentMethodsSheetPrimaryButtonBinding::inflate,
