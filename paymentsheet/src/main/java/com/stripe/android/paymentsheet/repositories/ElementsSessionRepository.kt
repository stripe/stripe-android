...
internal fun PaymentSheet.InitializationMode.toElementsSessionParams(externalPaymentMethods : List<String>): ElementsSessionParams {
    return when (this) {
        is PaymentSheet.InitializationMode.PaymentIntent -> {
            ElementsSessionParams.PaymentIntentType(clientSecret = clientSecret, externalPaymentMethods = externalPaymentMethods)
        }
        is PaymentSheet.InitializationMode.SetupIntent -> {
            ElementsSessionParams.SetupIntentType(clientSecret = clientSecret, externalPaymentMethods = externalPaymentMethods)
        }
