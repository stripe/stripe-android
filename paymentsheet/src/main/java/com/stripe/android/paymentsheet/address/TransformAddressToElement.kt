        ...
        when (it.type) {
            FieldType.AddressLine1 -> {
                SectionFieldSpec.SimpleText(
                    IdentifierSpec(Identifier.Line1.key),
            ...
            FieldType.AddressLine2 -> {
                SectionFieldSpec.SimpleText(
                    IdentifierSpec(Identifier.Line2.key),
            ...
            FieldType.Locality -> {
                SectionFieldSpec.SimpleText(
                    IdentifierSpec(Identifier.City.key),
            ...
            FieldType.AdministrativeArea -> {
                SectionFieldSpec.SimpleText(
                    IdentifierSpec(Identifier.State.key),
            ...
            FieldType.PostalCode -> {
                SectionFieldSpec.SimpleText(
                    IdentifierSpec(Identifier.PostalCode.key),
