...
internal class AddressOptionsActivityContract :
    ...
    override fun parseResult(resultCode: Int, intent: Intent?) =
        intent?.getParcelableExtra<Result>(EXTRA_RESULT)?.addressOptionsResult ?: AddressOptionsResult.Canceled(null)
    ...
    companion object {
        const val EXTRA_ARGS =
            "com.stripe.android.paymentsheet.AddressOptionsActivityContract.extra_args"
        const val EXTRA_RESULT =
            "com.stripe.android.paymentsheet.AddressOptionsActivityContract.extra_result"
    }
}