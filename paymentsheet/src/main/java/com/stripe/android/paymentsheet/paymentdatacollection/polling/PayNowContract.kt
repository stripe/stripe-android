...
internal class PayNowContract :
    ActivityResultContract<PayNowContract.Args, PaymentFlowResult.Unvalidated>() {

    override fun createIntent(context: Context, input: Args): Intent {
        val args = bundleOf(EXTRA_ARGS to input)
        return Intent(context, PayNowActivity::class.java).putExtras(args)
    }
