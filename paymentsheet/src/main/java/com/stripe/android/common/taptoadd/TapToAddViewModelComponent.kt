...
internal interface TapToAddViewModelModule {
    ...
    fun bindsPaymentMethodHolder(
        paymentMethodHolder: DefaultTapToAddPaymentMethodHolder,
    ): TapToAddPaymentMethodHolder

    @Binds
    fun bindsTapToAddFlowManager(
        tapToAddFlowManager: DefaultTapToAddFlowManager,
    ): TapToAddFlowManager
    ...
    companion object {
        ...
        fun providesAllowManualConfirmation(): Boolean = false
