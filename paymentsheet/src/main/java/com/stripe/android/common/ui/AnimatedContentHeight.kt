...
internal fun AnimatedContentHeight(
    ...
    animationSpec: AnimationSpec<Float> = DefaultAnimateContentHeightAnimation,
...
internal val DefaultAnimateContentHeightAnimation
    get() = spring(
        stiffness = Spring.StiffnessMediumLow,
        dampingRatio = Spring.DampingRatioNoBouncy,
        visibilityThreshold = IntSize.VisibilityThreshold.height.toFloat()
    )
