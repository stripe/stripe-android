...
import com.stripe.android.common.nfcscan.injection.DeviceManufacturer
import com.stripe.android.common.nfcscan.injection.DeviceModel
import com.stripe.android.common.nfcscan.injection.SdkVersion
...
internal class DefaultTapZoneResolver @Inject constructor(
    ...
    private companion object {
        val DEFAULT = TapZone(0.5f, 0.5f)
        val deviceTapZoneMapping = mapOf(
            // Samsung NFC locations are guesstimates based on https://www.samsung.com/hk_en/nfc-support/ or teardown videos
            "samsung" to mapOf(
                // S22+
