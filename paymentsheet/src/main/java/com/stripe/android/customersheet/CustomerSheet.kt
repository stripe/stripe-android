...
class CustomerSheet internal constructor(
    ...
    /**
     * A [CustomerSessionClientSecret] contains the parameters necessary for claiming a customer session.
     */
    @Poko
    ...
    class IntentConfiguration internal constructor(
        ...
        class Builder {
            ...
            /**
             * The payment methods types to display. If empty, we dynamically determine the payment method types
             * using your [Stripe Dashboard settings](https://dashboard.stripe.com/settings/payment_methods).
             */
    ...
    abstract class CustomerSessionProvider {
        /**
         * Creates an [IntentConfiguration] that is using when
         */
         ...
         *
         * @param customerId the Stripe identifier of the customer. This will be equivalent to the customer identifier
         *   passed through with the [CustomerSessionClientSecret].
         */
        abstract suspend fun provideSetupIntentClientSecret(customerId: String): Result<String>

        /**
         * Provides the [CustomerSessionClientSecret] that will be claimed and used to access a customer's saved
         * payment methods.
         */
    ...
    companion object {
        ...
        fun create(
            ...
            return getInstance(
                ...
                integrationType = CustomerSheetIntegrationType.Adapter(
         ...
         *
         * @param activity The [ComponentActivity] that is presenting [CustomerSheet].
         * @param customerSessionClientSecretProvider provides a customer session client secret
         * @param intentConfigurationProvider provides an intent configuration.
         * @param callback called when a [CustomerSheetResult] is available.
         */
        @JvmStatic
        @ExperimentalCustomerSessionApi
        ...
        /**
         * Create a [CustomerSheet] with `CustomerSession` features.
         *
