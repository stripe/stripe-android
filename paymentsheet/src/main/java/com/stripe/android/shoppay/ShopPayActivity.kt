...
internal class ShopPayActivity : ComponentActivity() {
    ...
    private fun ComposeWebView(viewModel: ShopPayViewModel) {
        val showPopup by viewModel.showPopup.collectAsState(initial = false)
    ...
    @Composable
    fun PopupWebViewDialog(viewModel: ShopPayViewModel) {
        val popupWebView by viewModel.popupWebView.collectAsState(initial = null)
