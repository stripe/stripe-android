...
internal class ManageNavigator private constructor(
    ...
    private val _complete = MutableSharedFlow<Unit>(replay = 1, extraBufferCapacity = 1)
    val complete: SharedFlow<Unit> = _complete.asSharedFlow()
    ...
    fun canGoBack(): Boolean {
        return navigationHandler.canGoBack
    }
