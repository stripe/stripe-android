...
internal class IntentConfirmationDefinition(
    ...
    override fun launch(
        ...
        val apiConfiguration = confirmationArgs.paymentMethodMetadata.apiConfiguration
        val paymentLauncher = paymentLauncherFactory(launcher, confirmationArgs.statusBarColor, apiConfiguration)
        when (arguments) {
