...
class IntentConfiguration internal constructor(
    ...
    sealed class Mode : Parcelable {
         ...
         * button, and influences available payment methods. See
         * [our docs](https://stripe.com/docs/api/payment_intents/create#create_payment_intent-amount) for more info.
    ...
    /**
     * Indicates that you intend to make future payments with this [PaymentIntent]'s payment method. See
     * [our docs](https://stripe.com/docs/api/payment_intents/create#create_payment_intent-setup_future_usage)
     * for more info.
     */
