...
internal class CheckoutControllerStateTest {
    ...
    @Test
    fun `asCheckoutSession keeps only wallets returned by metadata`() {
        val availableExpressButtonTypes = createSession(
            availableWallets = listOf(WalletType.GooglePay),
        ).availableExpressButtonTypes
    ...
    @Test
    fun `asCheckoutSession filters out wallets disabled by configuration`() {
        val availableExpressButtonTypes = createSession(
            availableWallets = listOf(WalletType.Link, WalletType.GooglePay),
            expressCheckoutConfiguration = ExpressCheckoutElement.Configuration()
    ...
    @Test
    fun `asCheckoutSession returns all available wallets`() {
        val availableExpressButtonTypes = createSession(
            availableWallets = listOf(WalletType.Link, WalletType.GooglePay),
        ).availableExpressButtonTypes
