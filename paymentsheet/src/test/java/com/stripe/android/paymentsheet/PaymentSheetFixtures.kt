...
internal object PaymentSheetFixtures {
    ...
    internal val PAYMENT_SHEET_CALLBACK_TEST_IDENTIFIER = UnscopedCallbacksKey("PaymentSheetTestIdentifier")
    internal val FLOW_CONTROLLER_CALLBACK_TEST_IDENTIFIER = UnscopedCallbacksKey("FlowControllerTestIdentifier")
