...
class DefaultUpdatePaymentMethodInteractorTest {
    ...
    fun updatingCardBrand_callsOnUpdateSuccess() {
        ...
        runScenario(
            ...
            cardEditUIHandlerFactory.cardEditUIHandler
                .onCardDetailsChanged(CardUpdateParams(cardBrand = CardBrand.Visa))
    ...
    fun updatingCardBrand_updatesStateAsExpected() {
        ...
        runScenario(
            ...
            cardEditUIHandlerFactory.cardEditUIHandler.onCardDetailsChanged(
                CardUpdateParams(cardBrand = CardBrand.CartesBancaires)
            )
    ...
    private fun updateCardBrandAndDefaultPaymentMethod(
        ...
        cardEditUIHandler.onCardDetailsChanged(
            CardUpdateParams(
