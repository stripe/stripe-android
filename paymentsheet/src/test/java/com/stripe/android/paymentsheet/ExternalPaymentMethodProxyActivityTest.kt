...
class ExternalPaymentMethodProxyActivityTest {
    ...
    fun `ExternalPaymentMethodInterceptor calls confirm handler`() {
        ...
        val callbackIdentifier = createTestIdentifier("ExternalPaymentMethod")
    ...
    fun `On separate instances, should be able to fetch proper callback`() {
        ...
        val firstIdentifier = createTestIdentifier("ExternalPaymentMethodTestIdentifierOne")
        PaymentElementCallbackReferences[firstIdentifier] = PaymentElementCallbacks.Builder()
            .externalPaymentMethodConfirmHandler(firstConfirmHandler)
            .build()

        val secondIdentifier = createTestIdentifier("ExternalPaymentMethodTestIdentifierTwo")
        PaymentElementCallbackReferences[secondIdentifier] = PaymentElementCallbacks.Builder()
            .externalPaymentMethodConfirmHandler(secondConfirmHandler)
            .build()

        activityLauncher.launch(
            input = ExternalPaymentMethodInput(
                paymentElementCallbackIdentifier = createTestIdentifier("ExternalPaymentMethodTestIdentifierOne"),
        ...
        activityLauncher.launch(
            input = ExternalPaymentMethodInput(
                paymentElementCallbackIdentifier = createTestIdentifier("ExternalPaymentMethodTestIdentifierTwo"),
                type = "external_fawry",
                billingDetails = PaymentMethod.BillingDetails(
