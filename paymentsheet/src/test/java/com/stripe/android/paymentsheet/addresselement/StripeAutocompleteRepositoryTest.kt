...
class StripeAutocompleteRepositoryTest {
    ...
    @Test
    fun `parseAutocompletePredictionsResponse uses display_data when primary text absent`() {
        val json = JSONObject(
            """
            {
              "source": "google",
    ...
    @Test
    fun `parseAutocompletePredictionsResponse prefers primary text over display_data`() {
        val json = JSONObject(
            """
            {
              "suggestions": [
    ...
    @Test
    fun `parseAutocompletePredictionsResponse returns empty list for absent suggestions`() {
        val json = JSONObject("{}")
    ...
    @Test
    fun `parseAutocompletePredictionsResponse skips entries with missing place_id`() {
        val json = JSONObject(
            """
            {
              "suggestions": [
    ...
    @Test
    fun `parseAutocompletePredictionsResponse parses inline address`() {
        val json = JSONObject(
            """
            {
              "suggestions": [
