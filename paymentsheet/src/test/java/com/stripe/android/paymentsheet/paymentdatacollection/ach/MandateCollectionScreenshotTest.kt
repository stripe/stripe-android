...
internal class MandateCollectionScreenshotTest {
    @get:Rule
    ...
    private val screenState = USBankAccountFormScreenState.MandateCollection(
        paymentAccount = FinancialConnectionsAccountFixtures.CHECKING_ACCOUNT,
