...
import com.stripe.android.paymentsheet.paymentdatacollection.ach.model.FinancialConnectionsAccountFixtures
...
internal class VerifyWithMicrodepositsScreenshotTest {
    @get:Rule
    ...
    private val screenState = USBankAccountFormScreenState.VerifyWithMicrodeposits(
        paymentAccount = FinancialConnectionsAccountFixtures.BANK_ACCOUNT,
