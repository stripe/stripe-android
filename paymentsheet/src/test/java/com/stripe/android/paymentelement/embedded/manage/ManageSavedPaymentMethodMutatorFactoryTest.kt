...
internal class ManageSavedPaymentMethodMutatorFactoryTest {
    ...
    @Test
    fun `payment options removal from root saved options screen does not navigate back or close`() = runScenario(
    ...
    private fun rootScreen(): EmbeddedNavigator.Screen {
        return EmbeddedNavigator.Screen.ManageAll(FakeManageScreenInteractor())
    }
