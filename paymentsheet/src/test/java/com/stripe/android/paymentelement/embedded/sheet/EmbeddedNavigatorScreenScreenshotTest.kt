...
internal class EmbeddedNavigatorScreenScreenshotTest {
    ...
    fun displaysVerticalPaymentOptionsWithWalletHeader() {
        ...
        snapshot(
            screen = screen,
            previousScreen = null,
            showsWalletsHeader = true,
            walletsHeader = { SheetWalletsHeaderContent(walletsState, screen.walletsDividerSpacing) },
        )
    }
    ...
    private fun snapshot(
        screen: EmbeddedNavigator.Screen,
        previousScreen: EmbeddedNavigator.Screen?,
