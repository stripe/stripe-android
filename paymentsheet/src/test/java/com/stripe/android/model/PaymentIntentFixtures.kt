...
internal object PaymentIntentFixtures {
    ...
    val ALIPAY_REQUIRES_ACTION_JSON = org.json.JSONObject(
        """
        {
    ...
    val ALIPAY_TEST_MODE_JSON = org.json.JSONObject(
        """
        {
          "id": "pi_1HDEFVKlwPmebFhpCobFP55H",
          "object": "payment_intent",
    ...
    val PI_REQUIRES_BLIK_AUTHORIZE_JSON = org.json.JSONObject(
        """
        {
    ...
    private val PI_REQUIRES_WECHAT_PAY_AUTHORIZE_JSON = org.json.JSONObject(
        """
        {
