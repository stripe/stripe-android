...
internal open class FakeLinkRepository : LinkRepository {
    ...
    var shareCardPaymentDetailsResult = Result.success(TestFactory.LINK_SAVED_PAYMENT_DETAILS.paymentMethod)
    ...
    override suspend fun shareCardPaymentDetails(
        ...
        id: String,
        consumerSessionClientSecret: String
    ): Result<PaymentMethod> = shareCardPaymentDetailsResult
