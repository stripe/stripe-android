...
private val swishAutomaticWithoutTaxExpectedParams = LpmBillingAddressFormParams(
    createParams = PaymentMethodCreateParams.createWithOverride(
        code = PaymentMethod.Type.Swish.code,
        billingDetails = null,
        requiresMandate = false,
...
private val swishFullExpectedParams = LpmBillingAddressFormParams(
    createParams = PaymentMethodCreateParams.createWithOverride(
        code = PaymentMethod.Type.Swish.code,
        billingDetails = PaymentMethod.BillingDetails(
            address = Address(
...
internal val swishTestCases = listOf(
    LpmBillingAddressFormValuesToParamsTestCase(
        ...
        expectedParams = swishNeverExpectedParams,
    ),
    LpmBillingAddressFormValuesToParamsTestCase(
        name = "Swish Automatic without tax",
        config = LpmBillingAddressTestConfiguration(
            paymentMethodType = PaymentMethod.Type.Swish,
    ...
    LpmBillingAddressFormValuesToParamsTestCase(
        ...
        rawValues = swishRawValues,
        expectedParams = swishFullExpectedParams,
    ),
)
