...
class GooglePayPaymentMethodLauncherContractV2 :
    ...
    /**
     * Args for launching [GooglePayPaymentMethodLauncherContractV2] to create a [PaymentMethod].
     *
    ...
    data class Args internal constructor(
        ...
        internal val totalPriceStatus: GooglePayJsonFactory.TransactionInfo.TotalPriceStatus?,
    ) : Parcelable {
