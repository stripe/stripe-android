...
sealed class PaymentMethodOptionsParams(
    ...
    /**
     * Options for confirming a Klarna payment.
     */
    @Parcelize
    @Poko
    class Klarna private constructor(
        private val interoperabilityToken: String?,
        private val partnerConfirmationToken: String?,
        internal val setupFutureUsage: ConfirmPaymentIntentParams.SetupFutureUsage?,
    ) : PaymentMethodOptionsParams(PaymentMethod.Type.Klarna) {

        class Builder {

            private var interoperabilityToken: String? = null
            private var partnerConfirmationToken: String? = null
            private var setupFutureUsage: ConfirmPaymentIntentParams.SetupFutureUsage? = null

            /**
             * Sets a token generated by the Klarna SDK for a pre-purchase interaction. Supported
             * for PaymentIntent and SetupIntent confirmation.
             */
            fun setInteroperabilityToken(interoperabilityToken: String): Builder = apply {
                this.interoperabilityToken = interoperabilityToken
            }

            /**
             * Sets a token generated by the Klarna SDK after successful payment authorization.
             * Supported only for PaymentIntent confirmation.
             */
            fun setPartnerConfirmationToken(partnerConfirmationToken: String): Builder = apply {
                this.partnerConfirmationToken = partnerConfirmationToken
            }

            /**
             * Sets whether this payment method is intended for future use. Supported only for
             * PaymentIntent confirmation.
             */
            fun setSetupFutureUsage(
            ...
            fun build(): Klarna {
                return Klarna(
                    ...
                    partnerConfirmationToken = partnerConfirmationToken,
                    setupFutureUsage = setupFutureUsage,
                )
            }
        }
        ...
        override fun createTypeParams(): List<Pair<String, Any?>> {
            return listOf(
                PARAM_INTEROPERABILITY_TOKEN to interoperabilityToken,
                PARAM_PARTNER_CONFIRMATION_TOKEN to partnerConfirmationToken,
                PARAM_SETUP_FUTURE_USAGE to setupFutureUsage?.code,
            )
        }
        ...
        private companion object {
            ...
            private const val PARAM_INTEROPERABILITY_TOKEN = "interoperability_token"
            private const val PARAM_PARTNER_CONFIRMATION_TOKEN = "partner_confirmation_token"
            private const val PARAM_SETUP_FUTURE_USAGE = "setup_future_usage"
        }
    }
...
fun PaymentMethodOptionsParams.setupFutureUsage(): ConfirmPaymentIntentParams.SetupFutureUsage? {
    return when (this) {
        ...
        is PaymentMethodOptionsParams.Klarna -> setupFutureUsage
...
fun PaymentMethodOptionsParams?.updateSetupFutureUsageWithPmoSfu(
    ...
    return when (this) {
        ...
        is PaymentMethodOptionsParams.Klarna -> this.copy(setupFutureUsage = sfuValueToSet)
