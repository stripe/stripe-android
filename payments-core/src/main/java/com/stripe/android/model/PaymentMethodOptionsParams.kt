...
sealed class PaymentMethodOptionsParams(
     ...
     *
     * @param interoperabilityToken A token generated by the Klarna SDK for a pre-purchase
     * interaction. Supported for PaymentIntent and SetupIntent confirmation.
     * @param partnerConfirmationToken A token generated by the Klarna SDK after successful payment
     * authorization. Supported only for PaymentIntent confirmation.
     */
    @KlarnaSDKPrivatePreview
    @Parcelize
    @Poko
    class Klarna @JvmOverloads constructor(
        var interoperabilityToken: String? = null,
        var partnerConfirmationToken: String? = null,
