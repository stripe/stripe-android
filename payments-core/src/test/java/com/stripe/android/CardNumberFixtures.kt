...
internal object CardNumberFixtures {
    ...
    val AMEX = com.stripe.android.ui.core.elements.CardNumber.Unvalidated(AMEX_NO_SPACES)
    ...
    val VISA = com.stripe.android.ui.core.elements.CardNumber.Unvalidated(VISA_NO_SPACES)

    const val VISA_DEBIT_NO_SPACES = "4000056655665556"
    const val VISA_DEBIT_WITH_SPACES = "4000 0566 5566 5556"
    val VISA_DEBIT = com.stripe.android.ui.core.elements.CardNumber.Unvalidated(VISA_DEBIT_NO_SPACES)
    ...
    val MASTERCARD = com.stripe.android.ui.core.elements.CardNumber.Unvalidated(MASTERCARD_NO_SPACES)
    ...
    val DINERS_CLUB_14 = com.stripe.android.ui.core.elements.CardNumber.Unvalidated(DINERS_CLUB_14_NO_SPACES)
    ...
    val DINERS_CLUB_16 = com.stripe.android.ui.core.elements.CardNumber.Unvalidated(DINERS_CLUB_16_NO_SPACES)
    ...
    val DISCOVER = com.stripe.android.ui.core.elements.CardNumber.Unvalidated(DISCOVER_NO_SPACES)

    const val JCB_NO_SPACES = "3566002020360505"
    const val JCB_WITH_SPACES = "3566 0020 2036 0505"
    val JCB_BIN = JCB_NO_SPACES.take(6)
    val JCB = com.stripe.android.ui.core.elements.CardNumber.Unvalidated(JCB_NO_SPACES)
    ...
    val UNIONPAY = com.stripe.android.ui.core.elements.CardNumber.Unvalidated(UNIONPAY_NO_SPACES)
}
