...
class CardUtilsTest {
    ...
    fun getPossibleCardBrand_withEmptyCard_returnsUnknown() {
        assertThat(com.stripe.android.CardUtils.getPossibleCardBrand("   ")).isEqualTo(CardBrand.Unknown)
    }

    @Test
    fun getPossibleCardBrand_withNullCardNumber_returnsUnknown() {
        assertThat(com.stripe.android.CardUtils.getPossibleCardBrand(null)).isEqualTo(CardBrand.Unknown)
    }

    @Test
    fun getPossibleCardBrand_withVisaPrefix_returnsVisa() {
        assertThat(com.stripe.android.CardUtils.getPossibleCardBrand("4899 99")).isEqualTo(CardBrand.Visa)
        assertThat(com.stripe.android.CardUtils.getPossibleCardBrand("4")).isEqualTo(CardBrand.Visa)
    }

    @Test
    fun getPossibleCardBrand_withAmexPrefix_returnsAmex() {
        assertThat(com.stripe.android.CardUtils.getPossibleCardBrand("345")).isEqualTo(CardBrand.AmericanExpress)
        assertThat(com.stripe.android.CardUtils.getPossibleCardBrand("37999999999")).isEqualTo(CardBrand.AmericanExpress)
    }

    @Test
    fun getPossibleCardBrand_withJCBPrefix_returnsJCB() {
        assertThat(com.stripe.android.CardUtils.getPossibleCardBrand("3535 3535")).isEqualTo(CardBrand.JCB)
    }

    @Test
    fun getPossibleCardBrand_withMasterCardPrefix_returnsMasterCard() {
        assertThat(com.stripe.android.CardUtils.getPossibleCardBrand("2222 452")).isEqualTo(CardBrand.MasterCard)
        assertThat(com.stripe.android.CardUtils.getPossibleCardBrand("5050")).isEqualTo(CardBrand.MasterCard)
    }

    @Test
    fun getPossibleCardBrand_withDinersClub16Prefix_returnsDinersClub() {
        assertThat(com.stripe.android.CardUtils.getPossibleCardBrand("303922 2234")).isEqualTo(CardBrand.DinersClub)
    }

    @Test
    fun getPossibleCardBrand_withDinersClub14Prefix_returnsDinersClub() {
        assertThat(com.stripe.android.CardUtils.getPossibleCardBrand("36778 9098")).isEqualTo(CardBrand.DinersClub)
    }

    @Test
    fun getPossibleCardBrand_withDiscoverPrefix_returnsDiscover() {
        assertThat(com.stripe.android.CardUtils.getPossibleCardBrand("60355")).isEqualTo(CardBrand.Discover)
        assertThat(com.stripe.android.CardUtils.getPossibleCardBrand("6433 8 90923")).isEqualTo(CardBrand.Discover)
        // This one has too many numbers on purpose. Checking for length is not part of the
        // function under test.
        assertThat(com.stripe.android.CardUtils.getPossibleCardBrand("6523452309209340293423")).isEqualTo(CardBrand.Discover)
    }

    @Test
    fun getPossibleCardBrand_withUnionPayPrefix_returnsUnionPay() {
        assertThat(com.stripe.android.CardUtils.getPossibleCardBrand("62")).isEqualTo(CardBrand.UnionPay)
    }

    @Test
    fun getPossibleCardBrand_withNonsenseNumber_returnsUnknown() {
        assertThat(com.stripe.android.CardUtils.getPossibleCardBrand("1234567890123456")).isEqualTo(CardBrand.Unknown)
        assertThat(com.stripe.android.CardUtils.getPossibleCardBrand("9999 9999 9999 9999")).isEqualTo(CardBrand.Unknown)
        assertThat(com.stripe.android.CardUtils.getPossibleCardBrand("3")).isEqualTo(CardBrand.Unknown)
    }
