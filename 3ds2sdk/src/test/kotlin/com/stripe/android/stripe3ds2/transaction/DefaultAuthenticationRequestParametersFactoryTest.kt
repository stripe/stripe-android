...
class DefaultAuthenticationRequestParametersFactoryTest {
    ...
    @Test
    fun getSDKTransactionId_shouldReturnProvidedTransactionId() = testDispatcher.runBlockingTest {
        assertThat(createParams().sdkTransactionId)
            .isEqualTo(SDK_TRANSACTION_ID)
    }

    @Test
    fun getDeviceData_withRsaKey_shouldReturnStringOfExpectedLength() =
    ...
    @Test
    fun getDeviceData_withECKey_shouldReturnStringOfExpectedLength() =
        testDispatcher.runBlockingTest {
    ...
    @Test
    fun getDeviceData_withRsaCert_shouldReturnStringOfExpectedLength() =
        testDispatcher.runBlockingTest {
            val encryptedDeviceData = createParams(
    ...
    @Test
    fun getSDKEphemeralPublicKey_withEcPublicKey_shouldReturnCorrectJwk() =
        testDispatcher.runBlockingTest {
    ...
    @Test
    fun sdkAppId_shouldReturnAppId() = testDispatcher.runBlockingTest {
        assertEquals(SDK_APP_ID, createParams().sdkAppId)
    }

    @Test
    fun sdkReferenceNumber_shouldReturnSDKReferenceNumber() = testDispatcher.runBlockingTest {
        assertEquals(SDK_REFERENCE_NUMBER, createParams().sdkReferenceNumber)
    }

    @Test
    fun getMessageVersion_shouldReturnMessageVersion() = testDispatcher.runBlockingTest {
        assertEquals(
    ...
    @Test
    fun `create() when error should throw SDKRuntimeException`() = testDispatcher.runBlockingTest {
