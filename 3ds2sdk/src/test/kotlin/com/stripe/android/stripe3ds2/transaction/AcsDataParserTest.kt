...
class AcsDataParserTest {
        ...
        verify(errorReporter).reportError(
            argWhere {
                it is IllegalArgumentException &&
                    it.message == "Failed to parse ACS data: {\"acsURL\":\"https://simulator-3ds.selftestplatform.com/v2.1.0/acs/946/\",\"acsEphemPubKey\":[],\"sdkEphemPubKey\":5}"
            }
        )
    ...
    fun `parse() with public keys represented as JSON objects should succeed`() {
        ...
        assertThat(
            acsData.acsUrl
        ).isEqualTo("https://testmode-acs.stripe.com/3d_secure_2_test/acct_123/threeds2_1HPOihJnhvQu/app_challenge/GXnh5fGIdB_oL4EeEc1BBrOYk=")
        assertThat(
