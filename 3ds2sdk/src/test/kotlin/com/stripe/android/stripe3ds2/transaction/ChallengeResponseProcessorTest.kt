...
class ChallengeResponseProcessorTest {
    ...
    @Test
    fun processPayload_withValidCresPayload_callsOnSuccess() = runTest {
    ...
    @Test
    fun processPayload_withValidErrorPayload_shouldCallOnError() = runTest {
    ...
    @Test
    fun processPayload_withEmptyPayload_shouldCallOnError() = runTest {
        val result = createProcessor()
    ...
    @Test
    fun processPayload_withCresSdkTransIdNotMatchingCreq_shouldCallOnError() = runTest {
        val cresData = ChallengeMessageFixtures.CRES.copy(
    ...
    @Test
    fun processPayload_withCresMessageVersionNotMatchingCreq_shouldCallOnError() = runTest {
        val cresData = ChallengeMessageFixtures.CRES.copy(
            isChallengeCompleted = true,
    ...
    @Test
    fun handleResponse_withInvalidResponseBody_shouldCallOnError() = runTest {
        val result = createProcessor(
            ...
            .isEqualTo(
                ChallengeRequestResult.ProtocolError(
                    ERROR_DATA.copy(
                        ...
                        errorDescription = "Data could not be decrypted by " +
                            "the receiving system due to technical or other reason.",
    ...
    @Test
    fun handleResponse_withErrorMessage_shouldCallOnError() = runTest {
