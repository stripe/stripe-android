...
internal sealed class SecurityCheck(
    ...
    class Tampered : SecurityCheck(WARNING) {
        ...
        private fun hasValidFields(): Boolean {
            val fieldCount = StripeThreeDs2ServiceImpl::class.java.declaredFields.filter { !it.isSynthetic }.size
            return fieldCount == 8
        }

        private fun hasValidMethods(): Boolean {
            val methodCount = StripeThreeDs2ServiceImpl::class.java.declaredMethods.filter { !it.isSynthetic }.size
