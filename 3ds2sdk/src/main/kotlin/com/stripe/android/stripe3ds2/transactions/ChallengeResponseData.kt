...
data class ChallengeResponseData constructor(
    ...
    internal val isValidForUi: Boolean
        ...
        get() {
            ...
            if (
                setOf(
                    challengeInfoHeader, challengeInfoLabel, challengeInfoText,
                    whyInfoLabel, whyInfoText, expandInfoLabel, expandInfoText,
            ...
            if (uiType == UiType.OutOfBand) {
                return setOf(
                    oobAppLabel, oobAppUrl, oobContinueLabel
                ).any {
                    !it.isNullOrBlank()
                }
            }
    ...
    data class Image constructor(
        ...
        val highestFidelityImageUrl: String?
            get() {
                return listOf(
                    extraHighUrl, highUrl, mediumUrl
                ).firstOrNull {
                    !it.isNullOrBlank()
                }
            }
