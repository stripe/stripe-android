...
/**
 * Adapter that populates a list with the shipping methods in {@link com.stripe.android.PaymentConfiguration}
 */
class ShippingMethodAdapter extends RecyclerView.Adapter<ShippingMethodAdapter.ViewHolder> {
    ...
    ShippingMethod getSelectShippingMethod() {
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(final ShippingMethodView shippingMethodView) {
            ...
            shippingMethodView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    setSelectedIndex(index != mSelectedIndex);
                }
            });
        }
        ...
        void setSelectedIndex(boolean selected) {
            if (selected) {
