...
public class CardMultilineWidget extends LinearLayout {
    ...
    public Card getCard() {
        ...
        if (validateAllFields()) {
            ...
            return card.addLoggingToken(LoggingUtils.CARD_WIDGET_TOKEN);
        }
    ...
    void initView(AttributeSet attrs) {
        ...
        inflate(getContext(), R.layout.card_input_multiline, this);

        mCardNumberEditText = findViewById(R.id.et_add_source_card_number);
        mExpiryDateEditText = findViewById(R.id.et_add_source_expiry);
        mCvcEditText = findViewById(R.id.et_add_source_cvc);
        mPostalCodeEditText = findViewById(R.id.et_add_source_zip);
        mTintColorInt = mCardNumberEditText.getHintTextColors().getDefaultColor();

        TextInputLayout cardInputLayout = findViewById(R.id.tl_add_source_card_number);
        TextInputLayout expiryInputLayout = findViewById(R.id.tl_add_source_expiry);
        mCvcTextInputLayout = findViewById(R.id.tl_add_source_cvc);
        TextInputLayout postalInputLayout = findViewById(R.id.tl_add_source_zip);

        // TODO: replace with localized strings
        mCardNumberEditText.setErrorMessage("Invalid card number");
        mExpiryDateEditText.setErrorMessage("Invalid date");
        mCvcEditText.setErrorMessage("Invalid CVC");
        mPostalCodeEditText.setErrorMessage("Invalid postal code");
