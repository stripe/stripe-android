...
public class CustomerSession implements EphemeralKeyManager.KeyManagerListener {
    ...
    private @Nullable
    ShippingFlowUpdateListener mShippingFlowUpdateListener;
    private @Nullable
    PaymentSession.ShippingInfoSubmittedListener mShippingInfoSubmittedListener;
    ...
    void notifyCustomerShippingInformationInvalid(@Nullable String error) {
        mShippingFlowUpdateListener.onError(400, error);
    }
    ...
    public void onKeyError(int errorCode, @Nullable String errorMessage) {
        ...
        if (mShippingFlowUpdateListener != null) {
            mShippingFlowUpdateListener.onError(errorCode, errorMessage);
            mShippingFlowUpdateListener = null;
        }
    }

    public void setShippingFlowUpdateListener(ShippingFlowUpdateListener shippingFlowUpdateListener) {
        mShippingFlowUpdateListener = shippingFlowUpdateListener;
    }

    void setShippingInfoSubmittedListener(PaymentSession.ShippingInfoSubmittedListener shippingInfoSubmittedListener) {
        mShippingInfoSubmittedListener = shippingInfoSubmittedListener;
    }
            ...
            public void handleMessage(Message msg) {
                ...
                switch (msg.what) {
                    ...
                    case CUSTOMER_SHIPPING_INFO_SAVED:
                        if (messageObject instanceof Customer) {
                            mCustomer = (Customer) messageObject;
                            mShippingFlowUpdateListener.onShippingInfoSaved();
                        }
                }
            }
        };
    ...
    /**
     * Implemented by Stripe.
     */
    public interface ShippingFlowUpdateListener {
        void onError(@NonNull int errorCode, @Nullable String errorMessage);
        void onShippingInfoSaved();
    }
