...
internal object SetupIntentFixtures {
    ...
    val SI_NEXT_ACTION_REDIRECT = requireNotNull(PARSER.parse(SI_NEXT_ACTION_REDIRECT_JSON))
    ...
    internal val SI_EXPANDED_PAYMENT_METHOD_JSON = JSONObject(
        """
        {
            "id": "seti_1GSmaFCRMbs",
            "object": "setup_intent",
    ...
    private val SI_REQUIRES_PAYMENT_METHOD_JSON = JSONObject(
        """
        {
            "id": "seti_1GSmaFCRMbs",
            "object": "setup_intent",
    ...
    val SI_REQUIRES_PAYMENT_METHOD = requireNotNull(PARSER.parse(SI_REQUIRES_PAYMENT_METHOD_JSON))
}
