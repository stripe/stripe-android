...
public class StripeJsonUtilsTest {
    ...
    @Test
    public void getString_whenFieldPresent_findsAndReturnsField() throws JSONException {
    ...
    @Test
    public void getString_whenFieldContainsRawNull_returnsNull() throws JSONException {
        JSONObject jsonObject = new JSONObject();
