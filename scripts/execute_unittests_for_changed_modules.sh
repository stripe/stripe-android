...
TESTABLE_MODULES="payments payments-core payments-model paymentsheet wechatpay link stripecardscan identity financial-connections stripe-core payments-ui-core camera-core stripe-ui-core payment-method-message"
