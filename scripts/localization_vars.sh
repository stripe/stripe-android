...
LANGUAGES="ar-SA,bg_BG,ca-ES,zh-Hans,zh-HK,zh-Hant,hr,cs-CZ,da,nl,en-GB,en,et-EE,fil,fi,fr-CA,fr,de,el-GR,hu,id,it,ja,ko,lt-LT,lv-LV,ms-MY,mt,nb,no,nn-NO,pl-PL,pt-BR,pt-PT,ro-RO,ru,sk-SK,sl-SI,es-419,es,sv,th,tr,vi"
