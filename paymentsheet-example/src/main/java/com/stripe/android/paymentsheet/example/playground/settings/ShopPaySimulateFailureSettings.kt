...
internal object ShopPaySimulateFailureSettings : BooleanSettingsDefinition(
    key = "ShopPaySimulateFailure",
    displayName = "Simulate Payment Failed for Shop Pay",
    defaultValue = false
) {
    ...
    override fun configure(
        ...
        ShopPayData.simulatePaymentFailed = value
    }
