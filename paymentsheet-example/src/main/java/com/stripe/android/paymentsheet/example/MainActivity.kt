...
import com.stripe.android.paymentsheet.example.samples.ui.customer.CustomerActivity
    ...
    private val items: List<MenuItem> by lazy {
        listOf(
            ...
            MenuItem(
                ...
                klass = CustomerActivity::class.java,
                section = MenuItem.Section.Customer,
                badge = MenuItem.Badge(
...
private fun MainScreen(items: List<MenuItem>) {
    ...
    LazyColumn {
        ...
        Section(
            title = "Customer",
            items = groupedItems.getOrElse(MenuItem.Section.Customer) { emptyList() }
        )
