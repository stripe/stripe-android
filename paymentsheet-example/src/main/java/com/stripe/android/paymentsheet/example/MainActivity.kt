...
import com.stripe.android.paymentsheet.example.playground.checkout.CheckoutControllerExampleCopyActivity
...
class MainActivity : AppCompatActivity() {
    ...
    private val items: List<MenuItem> by lazy {
        listOf(
            ...
            MenuItem(
                titleResId = R.string.checkout_controller_example_copy_title,
                subtitleResId = R.string.checkout_controller_example_copy_subtitle,
                klass = CheckoutControllerExampleCopyActivity::class.java,
                section = MenuItem.Section.Internal,
            ),
            MenuItem(
